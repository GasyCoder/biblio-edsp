...
<template>
    ...
    >
        ...
        <template v-else-if="name === 'students' || name === 'users'">
            <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" />
            <circle cx="9" cy="7" r="4" />
            <path d="M22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" />
        </template>
        <template v-else-if="name === 'books' || name === 'book-open'">
            <path
        ...
        <template v-else-if="name === 'copies'">
            <rect x="4" y="3" width="16" height="18" rx="2" />
            <path d="M8 7h8M8 11h8M8 15h5" />
        </template>
        <template v-else-if="name === 'visits' || name === 'activity'">
            <path d="M3 12h4l2-5 4 10 2-5h6" />
        </template>
        <template v-else-if="name === 'loans'">
        ...
        <template v-else-if="name === 'settings'">
            ...
            <path
                d="M19 12a7 7 0 0 0-.1-1l2-1.5-2-3.4-2.4 1a8 8 0 0 0-1.7-1L14.5 3h-5l-.4 3a8 8 0 0 0-1.7 1L5 6.1 3 9.5 5.1 11a7 7 0 0 0 0 2L3 14.5 5 18l2.4-1a8 8 0 0 0 1.7 1l.4 3h5l.4-3a8 8 0 0 0 1.7-1l2.4 1 2-3.5-2.1-1.5a7 7 0 0 0 .1-1Z"
            />
        </template>
        ...
        <template v-else-if="name === 'bell'">
            <path
                d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9M13.7 21h-3.4"
            />
        </template>
        ...
        <template v-else>
            <path
                d="m3 3 18 18M10.6 10.6a2 2 0 0 0 2.8 2.8M9.9 4.2A10.7 10.7 0 0 1 12 4c6.5 0 10 8 10 8a18 18 0 0 1-2.1 3.1M6.6 6.6C3.6 8.6 2 12 2 12s3.5 8 10 8a10 10 0 0 0 5.4-1.6"
            />
        </template>
    </svg>
</template>
