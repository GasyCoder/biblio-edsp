...
<head>
    ...
    <style>
        *{box-sizing:border-box}body{margin:0;padding:18px;background:#e2e8f0;font-family:Arial,sans-serif;color:#0f172a}.toolbar{display:flex;gap:8px;margin-bottom:16px}.toolbar button{border:0;border-radius:6px;padding:9px 13px;font-weight:700;cursor:pointer}.primary{background:#4f46e5;color:#fff}.secondary{background:#fff;color:#334155}.card{position:relative;width:85.6mm;height:53.98mm;overflow:hidden;border:.25mm solid #94a3b8;border-radius:3mm;background:#fff;box-shadow:0 8px 24px #47556944}.top{position:absolute;inset:0 0 auto;height:11mm;padding:2.4mm 4mm;background:#111a33;color:#fff}.school{font-size:10pt;font-weight:800;letter-spacing:.04em}.subtitle{margin-top:.5mm;font-size:5.8pt;letter-spacing:.12em;text-transform:uppercase;color:#c7d2fe}.photo{position:absolute;top:14mm;left:4mm;width:19mm;height:25mm;border:.25mm solid #cbd5e1;border-radius:1.5mm;object-fit:cover}.photo-placeholder{position:absolute;top:14mm;left:4mm;width:19mm;height:25mm;border:.25mm dashed #94a3b8;border-radius:1.5mm;background:#f1f5f9;text-align:center;padding-top:9mm;font-size:6pt;color:#64748b}.identity{position:absolute;top:14mm;left:26mm;width:34mm;height:29mm;overflow:hidden}.name{font-size:9pt;font-weight:800;line-height:1.15;text-transform:uppercase}.meta{margin-top:1.2mm;font-size:6.2pt;line-height:1.25;color:#475569}.meta strong{color:#0f172a}.qr{position:absolute;top:14mm;right:3.5mm;width:21mm;height:21mm}.qr svg{display:block;width:21mm!important;height:21mm!important}.card-number{position:absolute;top:36mm;right:3mm;width:22mm;text-align:center;font:700 5.8pt monospace}.footer{position:absolute;right:4mm;bottom:2.5mm;left:4mm;display:flex;justify-content:space-between;border-top:.2mm solid #e2e8f0;padding-top:1.4mm;font-size:5.5pt;color:#64748b}.footer strong{color:#334155}@media print{body{padding:0;background:#fff}.toolbar{display:none}.card{box-shadow:none}}
    </style>
</head>
<body>
