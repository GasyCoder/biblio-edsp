...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .label { position: absolute; width: 63.5mm; height: 33.9mm; overflow: hidden; border: .2mm dotted #94a3b8; }
        .qr { position: absolute; top: 4.45mm; left: 2mm; width: 25mm; height: 25mm; }
        .qr img { display: block; width: 25mm; height: 25mm; }
        .details { position: absolute; top: 2.5mm; right: 1.5mm; left: 29mm; height: 28.9mm; overflow: hidden; }
        .brand { margin: 0 0 .8mm; color: #4f46e5; font-size: 5.8pt; font-weight: bold; letter-spacing: .01em; white-space: nowrap; }
        .number { margin: 0 0 .8mm; font-family: DejaVu Sans Mono, monospace; font-size: 7.4pt; font-weight: bold; line-height: 1.1; white-space: nowrap; }
        .title { height: 17mm; overflow: hidden; color: #334155; font-size: 5.7pt; line-height: 1.2; overflow-wrap: break-word; }
    </style>
</head>
<body>
